            ...
            VStack{
                ...
                HStack {
                    ...
                    Image(gpuViewModel.upgradeIcon)
                        ...
                        .zIndex(1)
                        .lightningEffect(trigger: $lightningBolt, distance: 80, size: 15, duration: 1.1, boltCount: 5)
                    Spacer()
                    Image(ramViewModel.upgradeIcon)
                        ...
                        .zIndex(1)
                        .lightningEffect(trigger: $lightningBolt, distance: 80, size: 15, duration: 1.2, boltCount: 3)
                    ...
                    Image(ssdViewModel.upgradeIcon)
                        ...
                        .zIndex(1)
                        .lightningEffect(trigger: $lightningBolt, distance: 80, size: 15, duration: 0.9, boltCount: 3)
                    Spacer(minLength: 15)
                }
                Spacer(minLength: 20)
                HStack {
                    Image(rubberDuckViewModel.upgradeIcon)
                        ...
                        .zIndex(1)
                        .lightningEffect(trigger: $lightningBolt, distance: 160, size: 18, duration: 1, boltCount: 7)
                }
                Spacer(minLength: 20)
                HStack {
                    Spacer(minLength: 15)
                    Image(powerSupplyViewModel.upgradeIcon)
                        ...
                        .zIndex(1)
                        .lightningEffect(trigger: $lightningBolt, distance: 80, size: 15, duration: 0.8, boltCount: 3)
                    Spacer()
                    Image(motherBoardViewModel.upgradeIcon)
                        ...
                        .zIndex(1)
                        .lightningEffect(trigger: $lightningBolt, distance: 80, size: 15, duration: 1.3, boltCount: 5)
                    Spacer()
                    Image(hardDriveViewModel.upgradeIcon)
                        ...
                        .zIndex(1)
                        .lightningEffect(trigger: $lightningBolt, distance: 80, size: 15, duration: 1.1, boltCount: 3)
                    Spacer(minLength: 15)
                }
                Spacer(minLength: 40)
            }
