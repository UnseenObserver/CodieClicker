...
struct UpgradeView: View {
    ...
    @State var upgrades: [String:Upgrade] = [
        "ACPU1" :Upgrade(name: "Rinky-Dink CPU", add: true, value: 1, price: 10, id: 0, type: "CPU", strength: 0),
        "BCPU2" :Upgrade(name: "Nice CPU", add: true, value: 5, price: 750, id: 1, type: "CPU", strength: 1),
        "CCPU3" :Upgrade(name: "Lovely CPU", add: true, value: 100, price: 25000, id: 2, type: "CPU", strength: 2),
        "DPU4" :Upgrade(name: "Premium ", add: true, value: 1000, price: 10000000, id: 3, type: "CPU", strength: 3),
        
        "AGPU1" :Upgrade(name: "Rinky-Dink GPU", add: false, value: 1, price: 500, id: 4, type: "GPU", strength: 0),
        "BGPU2" :Upgrade(name: "Nice GPU", add: false, value: 2, price: 50000, id: 5, type: "GPU", strength: 1),
        "CGPU3" :Upgrade(name: "Add 3", add: false, value: 5, price: 100000, id: 6, type: "GPU", strength: 2),
        "DGPU4" :Upgrade(name: "Multi 2", add: false, value: 10, price: 1000000, id: 7, type: "GPU", strength: 3),
        
        "ASSD1" :Upgrade(name: "Rinky-Dink SSD", add: true, value: 2, price: 75, id: 8, type: "SSD", strength: 0),
        "BSSD2" :Upgrade(name: "Nice SSD", add: true, value: 10, price: 1500, id: 9, type: "SSD", strength: 1),
        "CSSD3" :Upgrade(name: "Lovely SSD", add: true, value: 200, price: 75000, id: 10, type: "SSD", strength: 2),
        "DSSD4" :Upgrade(name: "Premium SSD", add: true, value: 10000, price: 20000000, id: 11, type: "SSD", strength: 3),
        
        "ARAM1" :Upgrade(name: "Rinky-Dink RAM", add: false, value: 1, price: 5000, id: 12, type: "RAM", strength: 0),
        "BRAM2" :Upgrade(name: "Nice RAM", add: false, value: 2, price: 150000, id: 13, type: "RAM", strength: 1),
        "CRAM3" :Upgrade(name: "Lovely RAM", add: false, value: 5, price: 300000, id: 14, type: "RAM", strength: 2),
        "DRAM4" :Upgrade(name: "Premium RAM", add: false, value: 10, price: 42000000, id: 15, type: "RAM", strength: 3),
        
        "AhardDrive1" :Upgrade(name: "Rinky-Dink Hard Drive", add: true, value: 3, price: 250, id: 16, type: "HRD", strength: 0),
        "BhardDrive2" :Upgrade(name: "Nice Hard Drive", add: true, value: 15, price: 7500, id: 17, type: "HRD", strength: 1),
        "ChardDrive3" :Upgrade(name: "Lovely Hard Drive", add: true, value: 300, price: 100000, id: 18, type: "HRD", strength: 2),
        "DhardDrive4" :Upgrade(name: "Premium Hard Drive", add: true, value: 100000, price: 30000000, id: 19, type: "HRD", strength: 3),
        
        "ApowerSupply1" :Upgrade(name: "Rinky-Dink Power Supply", add: false, value: 1, price: 10000, id: 20, type: "PWS", strength: 0),
        "BpowerSupply2" :Upgrade(name: "Nice Power Supply", add: false, value: 2, price: 200000, id: 21, type: "PWS", strength: 1),
        "CpowerSupply3" :Upgrade(name: "Lovely Power Supply", add: false, value: 5, price: 400000, id: 22, type: "PWS", strength: 2),
        "DpowerSupply4" :Upgrade(name: "Premium Power Supply", add: false, value: 10, price: 42000000, id: 23, type: "PWS", strength: 3),
        
        "AmotherBoard1" :Upgrade(name: "Rinky-Dink Mother Board", add: true, value: 4, price: 500, id: 24, type: "MTB", strength: 0),
        "BmotherBoard2" :Upgrade(name: "Nice Mother Board", add: true, value: 20, price: 15000, id: 25, type: "MTB", strength: 1),
        "CmotherBoard3" :Upgrade(name: "Lovely Mother Board", add: true, value: 400, price: 150000, id: 26, type: "MTB", strength: 2),
        "DmotherBoard4" :Upgrade(name: "Premium Mother Board", add: true, value: 1000000, price: 40000000, id: 27, type: "MTB", strength: 3),
        
        "Aduck1" :Upgrade(name: "Rinky-Dink Rubber Duck", add: false, value: 1, price: 20000, id: 28, type: "RUB", strength: 0),
        "Bduck2" :Upgrade(name: "Nice Rubber Duck", add: false, value: 2, price: 300000, id: 29, type: "RUB", strength: 1),
        "Cduck3" :Upgrade(name: "Lovely Rubber Duck", add: false, value: 5, price: 600000, id: 30, type: "RUB", strength: 2),
